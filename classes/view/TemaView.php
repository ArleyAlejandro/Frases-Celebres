	...
	<div class="container">
        ...
        foreach ($temas as $tema) {
            ...
            echo " <tbody>
                                <tr>
                                    <td>" . $tema["name"] . "</td>
                                    <td>" . $tema["total_frases"] . "</td>
                                    <td>";
            echo '<button style:"widht:20%;" class="btn-edit" onclick="location.href=\'?tema/editForm/' . $tema['id'] . '\'">Editar</button>';
            echo "   <button class=\"btn-delete\" onclick=\"location.href='?tema/deleteTema/" . $tema['id'] . " '\"> Eliminar</button>
                                    </td>   
                                </tr>
                            </tbody>";
        }
